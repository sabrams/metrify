...
This will grant the following functionality to the MetricsClass defined above:
  ...
  example_finish_date = Time.now.midnight
  number_of_days = 7
  historical_values = MetrifiedClass.historical_values(example_finish_date, 10, :day) # => returns array of 10 aggregations, each over 1 day, older values listed first, ended at the most recent aggregation date (example_finish_date). (:day, :month options)
